# Forked from : Luke's Auto-Rice Bootstraping Scripts (LARBS)
...
```
git clone https://github.com/eth-man/larbs.git
sh larbs.sh
```
...
[my dotfiles repo (voidrice) here](https://github.com/eth-man/voidrice),
